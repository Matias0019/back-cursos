 ...
 */
const processContentCreate = async (content:any): Promise<boolean> => {
 ...
 *  @param content any
 */
const processContentDelete = async (content:any): Promise<boolean> => {
    content =  JSON.parse(content) 
...
const processContentUpdate = async (content:any): Promise<boolean> => {
    content =  JSON.parse(content) 
    console.log(content)
...
export const recieverDeleteAccountUserKafka = async () => {
    ...
    try {
        ...
        const groupID = "userDeletDocumento";
...
export const recieverUpdateAccountUser = async () => {
    ...
    try {
        ...
        const exchangeName = "user";
        const exchangeType = "topic";
        const queue = "proyectoUpdateUser";
...
export const recieverUpdateAccountUserKafka = async () => {
        ...
        try {
            ...
            const groupID = "userUpdateDocumento";

...
import { NewCreatedUser, UpdateUserBody, IUserDoc, NewRegisteredUser, NewCreatedUserByBroken } from './user.interfaces';
 ...
 */
export const createUser = async (userBody: NewCreatedUser | NewCreatedUserByBroken): Promise<IUserDoc> => {
